...
func main() {
	...
	config := lib.GetJsonConfig(config_path)

	// fmt.Println("Read configuration successfully:", config)
	save_path := os.Args[2]
	videoidstr := os.Args[3]
	...
	// fmt.Println("query_result.Car.LIMIT_F1, query_result.Car.LIMIT2_F1, query_result.Car.LIMIT3_ACC: ", query_result.Car.LIMIT_F1, query_result.Car.LIMIT2_F1, query_result.Car.LIMIT3_ACC)
	...
	step_output := StepOutput{
		...
		query_result.Car.GT_COUNT, query_result.Car.PRED_COUNT,
