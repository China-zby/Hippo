    ...
    with Progress(*custom_columns) as progress:
        ...
        for batch in range(0, episodes, batch_size):
            ...
            for episode in range(batch_size):
                ...
                pareto_set_gt = sorted(pareto_set_gt, key=lambda x: x[0])
...
if __name__ == "__main__":
    ...
    channel = 800
    method_name = "detective_reinforce_all_context_fit_pareto"
    data_name = "hippo"
    scene_name = "hippo"
    ...
    log_dir = "./reinforce_tensorboard_all_context_fit_pareto/"
    ...
    reinforce(env, test_env, policy, optimizer,
              batch_size, update_step,
