...
# 方法定义
methods = ['unitune','otif', 'skyscraper','hippo']
# methods = ['otif', 'hippo']
...
# 遍历文件夹中的每个子文件夹
for subfolder in ['100', '150', '200', '250', '300']: # os.listdir(folder_path): '100', '150', '200', '250', '300', '150', '200', '250', '300'
